...
def test_load_data():
    ...
    df_ref = pd.read_csv('C:\\Users\\Btissam\\Downloads\\data_camp\\2023_assignment_pandas\\referendum.csv', sep=';')
    assert set(referendum.columns) == set(df_ref.columns)

    df_reg = pd.read_csv('C:\\Users\\Btissam\\Downloads\\data_camp\\2023_assignment_pandas\\regions.csv')
    assert set(regions.columns) == set(df_reg.columns)

    df_dep = pd.read_csv('C:\\Users\\Btissam\\Downloads\\data_camp\\2023_assignment_pandas\\departments.csv')
