...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    a = a.dropna()
    a = a[~a['code_reg'].isin(['COM', 'TOM', 'DOM'])]
    a = a[a["Department name"] != "FRANCAIS DE L'ETRANGER"]
    return a
...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    """
    referendum_and_areas = referendum_and_areas.groupby('code_reg').agg({
        'name_reg': 'first',
        'Registered': 'sum',
        'Abstentions': 'sum',
        'Null': 'sum',
    ...
    selected_columns = ['name_reg', 'Registered',
                        'Abstentions', 'Null',
                        'Choice A', 'Choice B']
    referendum_and_areas = referendum_and_areas[selected_columns]
