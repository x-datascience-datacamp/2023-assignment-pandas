...
def merge_regions_and_departments(regions, departments):
    ...
    """
    dataframe = regions.merge(departments, left_on='code',
                              right_on='region_code',
                              suffixes=('_reg', '_dep'))
    dataframe = dataframe[['code_reg', 'name_reg', 'code_dep', 'name_dep']]
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    merged_df = filtered_referendum.merge(regions_and_departments,
