...
def merge_regions_and_departments(regions, departments):
    ...
    col = ['code_reg', 'name_reg', 'code_dep', 'name_dep']
    return regions_and_departments[col]
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    # List of codes representing DOM-TOM-COM
    drop_codes = ['01', '02', '03', '04', '06', 'COM']

    # Filter out DOM-TOM-COM rows from regions_and_departments
    filtered_regions_and_departments = regions_and_departments[
        ~regions_and_departments['code_reg'].isin(drop_codes)
        ]

    referendum_and_areas = pd.merge(
        referendum,
        filtered_regions_and_departments,
        right_on='code_dep',
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    # (excluding Null and Abstentions)
