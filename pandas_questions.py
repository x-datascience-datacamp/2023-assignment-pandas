...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    """
    referendum_result_by_regions = referendum_and_areas.groupby('name_reg').agg({
        'Registered': 'sum',
        'Abstentions': 'sum',
        'Null': 'sum',
        'Choice A': 'sum',
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    print(geo_data.head())
    gdf_referendum= pd.merge(geo_data, referendum_result_by_regions, on='name_reg')

    gdf_referendum['ratio'] = gdf_referendum['Choice A'] / (gdf_referendum['Choice A'] + gdf_referendum['Choice B'])
