...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    # List of Region codes representing DOM-TOM-COM
    DOM_TOM_COM_tickers = ["01", "02", "03", "04", "06", "COM"]

    # Filter out DOM-TOM-COM rows from regions_and_departments
    filtered_regions_and_departments = regions_and_departments[
        ~regions_and_departments["code_reg"].isin(DOM_TOM_COM_tickers)]

    merged_df = pd.merge(referendum, filtered_regions_and_departments,
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    final_data = gpd.GeoDataFrame(
         merged_gdf[["name_reg", "ratio", "geometry"]]
    )

    # Data plot
    final_data.plot(column='ratio', legend=True)
...
if __name__ == "__main__":
    ...
    plt.title("Ratio of choice A vs Regions")
    plt.show()
